## agile_grasp (hydro) - 0.7.2-0

The packages in the `agile_grasp` repository were released into the `hydro` distro by running `/usr/bin/bloom-release agile_grasp --track hydro --rosdistro hydro` on `Sat, 16 May 2015 18:53:30 -0000`
...
## agile_grasp (indigo) - 0.7.2-0

The packages in the `agile_grasp` repository were released into the `indigo` distro by running `/usr/bin/bloom-release agile_grasp --track indigo --rosdistro indigo` on `Sat, 16 May 2015 16:55:39 -0000`
...
## agile_grasp (indigo) - 0.7.0-0

The packages in the `agile_grasp` repository were released into the `indigo` distro by running `/usr/bin/bloom-release agile_grasp --track indigo --rosdistro indigo` on `Thu, 14 May 2015 00:37:23 -0000`
